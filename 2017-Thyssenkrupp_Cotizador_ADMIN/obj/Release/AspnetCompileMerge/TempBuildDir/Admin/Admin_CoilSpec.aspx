	...
	<div class="container" id="page-content-wrapper" style="position: fixed; overflow: scroll; height: 100%">
		...
		<div class="row" style="height: 1100px;">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				<telerik:RadGrid ID="RadGrid_MaterialType" runat="server"  AllowAutomaticUpdates="True" AutoGenerateColumns="False"  
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				<telerik:RadGrid ID="RadGrid_CoilSpec" runat="server" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" AllowSorting="True" AutoGenerateColumns="False" AutoGenerateDeleteColumn="True" AutoGenerateEditColumn="True" 
